...
[![Version 5.9.0](https://img.shields.io/badge/version-5.9.0-green.svg)](VERSION)
...
Older releases are preserved in Git tags and GitHub releases. The 5.2.0, 5.3.0, 5.3.x release-candidate, 5.4.0, 5.5.0, 5.7.5, 5.7.6, 5.8.0-rc.2, 5.8.0-rc.6, 5.8.1, 5.8.2, 5.8.3-rc.1, 5.8.3-rc.2, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
