...
[![Version 5.15.0-rc.11](https://img.shields.io/badge/version-5.15.0--rc.11-green.svg)](VERSION)
...
Older releases are preserved in Git tags and GitHub releases. The 5.2.0 through 5.14.0 stable rows (and every 5.x rc tag prior to 5.15.0-rc.7, including v5.15.0-rc.1 through v5.15.0-rc.6) and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
